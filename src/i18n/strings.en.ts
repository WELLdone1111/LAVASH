export const STRINGS_EN: Record<string, string> = {
  ...
  "settings.ytmApi.lead":
    "Library, home, and search use Python. After Google sign-in in LAVASH, cookies are copied automatically from WebView2.",
  "settings.ytmApi.enabled": "API enabled",
  "settings.ytmApi.headers": "Headers file",
  "settings.ytmApi.python": "Python",
  "settings.ytmApi.script": "ytmusic_api.py script",
  "settings.ytmApi.path": "Path",
  "settings.ytmApi.yes": "yes",
  "settings.ytmApi.no": "no",
  "settings.ytmApi.ready": "Ready — open Player.",
  "settings.ytmApi.notReady":
    "Sign in to Google in the Player. Requires Python and pip install -r scripts/requirements-ytm.txt.",
  "settings.ytmApi.syncHeaders": "Sync cookies from WebView",
  "settings.ytmApi.syncing": "Syncing…",
  "settings.ytmApi.refresh": "Refresh status",
  ...
  "appearance.target.main": "Main player",
  "appearance.target.mini": "Mini player",
  "appearance.themes.mainLead": "Applies to the main window and dock.",
  "appearance.themes.miniLead": "Applies to floating mini player windows.",
  "appearance.themes.appLead": "Palette for the whole LAVASH UI (dock, panels).",
  "appearance.wallpapers.mainLead": "Background behind the main player workspace.",
  "appearance.wallpapers.miniLead": "Background on each floating mini card.",
  ...
  "settings.confirm.factoryBody": `The following will be removed: presets (and the on-disk file on desktop), LavashConstruct settings, chat (models and API keys), code scratchpad, YouTube Music webview session, floating mini windows, the selected player preset, and saved LavashConstruct panel sizes.
...
The app will reload. This cannot be undone.`,
  ...
  "window.ytmHistory": "Listening history",
  "window.ytmCast": "Cast to another device",
  ...
  "auth.signInHeadline": "Sign in to LAVASH",
  "auth.signInYoutubeMusic": "Sign in to YouTube Music",
  "auth.greeting": "Hello, {{name}}",
  "auth.greetingFallback": "there",
  "auth.signOut": "Sign out",
  "auth.signOutConfirm": "Sign out of YouTube Music on this device?",
  "auth.clearYtmSession": "Reset YouTube Music session",
  "auth.clearYtmSessionConfirm":
    "Sign out of Google and delete WebView2 cookies? You will need to sign in again. Wait a few seconds after confirming.",
  "auth.clearYtmSessionProgress": "Resetting session…",
  "auth.openingYoutubeMusic": "Opening player…",
  "auth.youtubeMusicNotice":
    "A separate music.youtube.com window will open (like a browser). Your session is saved — the player picks it up automatically.",
  "auth.signedInYoutubeMusic": "You are signed in to YouTube Music. Your avatar appears in the dock.",
  "auth.desktopOnly": "YouTube Music sign-in is available in the LAVASH desktop app (Tauri).",
  "auth.testingContact": "Contact the author",
  "auth.signInSpotify": "Sign in to Spotify",
  "auth.spotifyStubHint": "Coming soon: Spotify sign-in is not wired up yet.",
  "auth.privacy": "Privacy Policy",
  "auth.terms": "Terms of Service",

  "legal.accept.title": "Terms & Privacy",
  "legal.accept.lead":
    "Before using LAVASH, please read the Terms of Service and Privacy Policy. By clicking “I agree”, you accept both documents.",
  "legal.accept.alpha": "LAVASH is alpha software provided without warranties. You use it at your own risk.",
  "legal.accept.autostart":
    "By default, LAVASH starts with Windows. Collapse the panel to a desktop bun — click it to open the player. Turn off autostart in Settings.",
  "legal.accept.button": "I agree",

  "player.aria": "Main player",
  "player.sidebar.aria": "YouTube Music navigation",
  "player.sidebar.brand": "YouTube Music",
  "player.sidebar.home": "Home",
  "player.sidebar.explore": "Explore",
  "player.sidebar.library": "Library",
  "player.browser.title": "Embedded YouTube Music",
  "player.browser.body": "The browser build does not include the second YTM webview. Run the LAVASH Tauri app to see music.youtube.com in the center with the custom transport bar.",
  "player.embed.hint":
    "You can listen without an account. For library and recommendations, sign in via Profile → YouTube Music.",
  "player.login.banner":
    "YouTube Music sign-in required. Open Login in the dock (profile icon) → Sign in to YouTube Music. Cookies sync automatically.",
  "player.login.inWebview":
    "Sign in only in the Login section (profile in the dock), not in the player.",
  "player.home.aria": "YouTube Music home",
  "player.home.more": "More",
  "player.home.artistRole": "Artist",
  "player.api.setupRequired":
    "Sign in to Google in the Login section (profile in the dock). Requires Python: pip install -r scripts/requirements-ytm.txt. Cookies sync automatically after sign-in.",
  "player.api.webviewFallback":
    "Loading via WebView… For faster feeds: sign in under Login + Python (ytmusicapi).",
  "player.api.headersPath": "Headers file",
  "player.api.emptyHome": "Home feed is empty — check Google sign-in (cookies in headers).",
  "player.api.emptyLibrary": "Library is empty — check cookies or section.",
  "player.home.loading": "Loading recommendations (ytmusicapi)…",
  "player.home.slow":
    "This is taking longer than usual — often due to VPN or a slow connection. Try another VPN server, allow LAVASH and WebView2 in the firewall, or tap Retry.",
  "player.home.retry": "Retry",
  "player.home.empty":
    "Could not load shelves. Sign in to YouTube Music (Profile) or tap Retry.",
  "player.home.shelf.listenAgain": "Listen again",
  "player.home.shelf.mixedForYou": "Mixed for you",
  "player.home.shelf.topCharts": "Top charts",
  "player.home.shelf.recommended": "Recommended",
  "player.home.shelf.newReleases": "New releases",
  "player.home.shelf.quickPicks": "Quick picks",
  "player.home.shelf.generic": "Shelf",
  "player.home.shelf.results": "Results",
  "player.browse.aria": "YouTube Music shelves",
  "player.browse.playNext": "Play next",
  "player.browse.addToQueue": "Add to queue",
  "player.artist.aria": "Artist page",
  "player.artist.back": "Back",
  "player.artist.play": "Play",
  "player.artist.radio": "Radio",
  "player.artist.subscribe": "Subscribe",
  "player.artist.tracks": "Music",
  "player.artist.videos": "Videos",
  "player.artist.loading": "Loading artist page…",
  "player.artist.loadFailed": "Could not load artist. Sign in to Google in LAVASH Profile.",
  "player.artist.emptyTracks": "Tracks will appear once YouTube Music finishes loading.",
  "player.artist.fallbackName": "Artist",
  "player.embed.errorPrefix": "Player:",
  "player.browser.open": "Open music.youtube.com in a tab",
  "player.search.aria": "Search YouTube Music",
  "player.search.placeholder": "Search songs, albums, artists, podcasts",
  "player.moods.toolbarAria": "Quick picks by mood and activity",
  "player.explore.toolbarAria": "YouTube Music explore shortcuts",
  "player.explore.hubAria": "YouTube Music explore",
  "player.explore.hubTitle": "Explore",
  "player.explore.hubLead": "New releases, charts, and mood playlists — like music.youtube.com/explore.",
  "player.explore.newReleases": "New releases",
  "player.explore.newReleasesDesc": "Fresh albums and singles",
  "player.explore.charts": "Charts",
  "player.explore.chartsDesc": "Top songs and videos",
  "player.explore.moodsGenres": "Moods & genres",
  "player.explore.moodsGenresDesc": "Chill, workout, pop, rock, and more",
  "player.explore.back": "Back",
  "player.explore.loading": "Loading section from YouTube Music…",
  "player.explore.feedAria": "Explore section content",
  "player.explore.shelf.newAlbums": "New albums & singles",
  "player.explore.shelf.newReleases": "New releases",
  "player.explore.shelf.topSongs": "Top songs",
  "player.explore.shelf.topArtists": "Top artists",
  "player.explore.shelf.charts": "Charts",
  "player.explore.shelf.moodsGenres": "Moods & genres",
  "player.explore.shelf.trending": "Trending",
  "player.explore.shelf.videos": "Videos",
  "player.explore.shelf.generic": "Shelf",
  "player.library.loading": "Loading your library from YouTube Music…",
  "player.library.aria": "YouTube Music library",
  "player.library.subtitle": "Your personal sonic collection.",
  "player.library.toolbarAria": "YouTube Music library sections",
  "player.library.playlists": "Playlists",
  "player.library.songs": "Liked",
  "player.library.albums": "Albums",
  "player.library.artists": "Artists",
  "player.library.profiles": "Profiles",
  "player.library.podcasts": "Podcasts",
  "player.library.yourPlaylists": "Your playlists",
  "player.library.yourAlbums": "Your albums",
  "player.library.likedSongs": "Liked songs",
  "player.library.yourArtists": "Your artists",
  "player.library.recent": "Recently played",
  "player.library.recentTracks": "Recently played tracks",
  "player.library.viewAll": "View all",
  "player.library.emptyMain": "Nothing here yet. Sign in to YouTube Music from Profile.",
  "player.library.emptySignedIn": "Nothing here yet. Tap Retry below or check Python (ytmusicapi) in Settings.",
  "player.library.emptyRecent": "No recent tracks yet.",
  "player.mood.workout": "Workout — open a search mix",
  "player.mood.energy": "Energy — open a search mix",
  "player.mood.happy": "Good mood — open a search mix",
  "player.mood.relax": "Relax — open a search mix",
  "player.mood.party": "Party — open a search mix",
  "player.mood.commute": "Daily commute — open a search mix",
  "player.mood.romance": "Romance — open a search mix",
  "player.mood.sad": "Sad mood — open a search mix",
  "player.mood.focus": "Focus — open a search mix",
  "player.mood.sleep": "Sleep — open a search mix",
  "player.moodQ.workout": "workout music",
  "player.moodQ.energy": "high energy upbeat music",
  "player.moodQ.happy": "happy feel good music",
  "player.moodQ.relax": "chill relax music",
  "player.moodQ.party": "party dance music",
  "player.moodQ.commute": "commute driving music",
  "player.moodQ.romance": "romantic love songs",
  "player.moodQ.sad": "sad songs",
  "player.moodQ.focus": "focus concentration music",
  "player.moodQ.sleep": "sleep music ambient",
  "player.transport.aria": "Playback controls",
  "player.transport.nothingPlaying": "Nothing playing",
  "player.transport.play": "Play",
  "player.transport.pause": "Pause",
  "player.transport.prev": "Previous track",
  "player.transport.next": "Next track",
  "player.transport.dislike": "Not for me",
  "player.transport.volume": "Volume",
  "player.transport.volumeSlider": "Track volume",
  "player.transport.like": "Like",
  "player.transport.more": "More track actions",
  "player.transport.menu.aria": "Track actions",
  "player.transport.menu.startRadio": "Start radio",
  "player.transport.menu.playNext": "Play next",
  "player.transport.menu.addToQueue": "Add to queue",
  "player.transport.menu.saveToLibrary": "Save to library",
  "player.transport.menu.addToLiked": "Add to liked songs",
  "player.transport.menu.download": "Download",
  "player.transport.menu.saveToPlaylist": "Save to playlist",
  "player.transport.menu.removeFromQueue": "Remove from queue",
  "player.transport.menu.goToAlbum": "Go to album",
  "player.transport.menu.goToArtist": "Go to artist page",
  "player.transport.menu.share": "Share",
  "player.transport.menu.pinListenAgain": "Pin to “Listen again”",
  "player.transport.menu.dismissQueue": "Dismiss queue",

  "presets.title": "Styles",
  "presets.sectionTabsAria": "Layouts, themes, or wallpapers",
  "presets.tab.presets": "Layouts",
  "presets.tab.themes": "Themes",
  "presets.tab.wallpapers": "Wallpapers",
  "presets.modeTabsAria": "Main or mini player",
  "presets.main": "Main",
  "presets.mini": "Mini",
  "presets.app": "App",
  "presets.appearanceModeTabsAria": "Main, mini, or whole app",
  "presets.searchPlaceholder": "Search presets…",
  "presets.searchThemesPlaceholder": "Search themes…",
  "presets.searchWallpapersPlaceholder": "Search wallpapers…",
  "presets.searchEmpty": "Nothing matched your search.",
  "presets.sortAria": "Sort presets",
  "presets.filterAria": "Filter presets",
  "presets.createMain": "Create New Main Player",
  "presets.createMini": "Create New Mini Player",
  "presets.importMain": "Import",
  "presets.store": "Store",
  "presets.importMainAria": "Import main player preset from file",
  "presets.storeAria": "Open store — main player packs",
  "presets.importFailed": "Could not read preset file. Use a LAVASH main preset JSON export.",
  "presets.importSuccess": "Imported {{count}} main preset(s).",
  "presets.splitConstruct": "Lab",
  "presets.splitConstructAria": "Open LavashConstruct to create your mini player",
  "presets.noLayout": "No layout snapshot",
  "presets.modeLine": "Mode: {{mode}}",
  "presets.modeMain": "Main Player",
  "presets.modeMini": "Mini Player",
  "presets.snap": "Snap: {{px}}px",
  "presets.updated": "Updated: {{date}}",
  "presets.apply": "Apply",
  "presets.lavashConstruct": "LavashConstruct",
  "presets.rename": "Rename",
  "presets.delete": "Delete",
  "presets.empty": "No saved presets yet. Create one in LavashConstruct.",
  "presets.renamePromptTitle": "Rename preset",
  "presets.deleteConfirm": "Delete preset \"{{name}}\"?",

  "construct.top.modeTabsAria": "Player mode",
  "construct.top.main": "Main",
  "construct.top.mini": "Mini",
  ...
  "construct.themesWallpapersInPresets": "Themes and wallpapers are in Styles (Themes / Wallpapers tabs).",
  "construct.themesInPresets": "Built-in themes are in Styles → Themes.",
  ...
  "construct.wallpapers.step1": "Pick player: {{target}}.",
  ...
  "construct.wallpapers.step4": "If the code is OK — Apply sets the wallpaper on the selected player.",
  ...
  "construct.workspace.createMiniCta": "Create your mini",
  "construct.workspace.createMiniHint": "Create your mini",
